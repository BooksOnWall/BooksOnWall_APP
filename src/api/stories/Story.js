...
export default class Story extends Component {
  ...
  getCurrentLocation = async () => {
    try {
      ...
      error => error => Toast.showWithGravity(I18n.t("POSITION_UNKNOWN","Your GPS position is unknown, are you inside a buiding ? please go outside.", Toast.LONG, Toast.TOP),
